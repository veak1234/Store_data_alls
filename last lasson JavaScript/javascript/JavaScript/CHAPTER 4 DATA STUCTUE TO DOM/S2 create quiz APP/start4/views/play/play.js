...
function saveQuestions() {
  //   TODO your code
  localStorage.setItem("questions",JSON.stringify(questions)); /// localStorage 
  // let storage = JSON.parse(localStorage.getItem("questions")); ///get items back
...
function loadQuestions() {
  ...
  let storageQuestions = storage = JSON.parse(localStorage.getItem("questions"));  // get itme back
  console.log(storageQuestions)
  if(storageQuestions !== null){
    storageQuestions = questions;
