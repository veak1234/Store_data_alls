...
function renderQuestion() {
  ...
  let indexOfQuestion = questions[runningQuestionIndex];
  ...
  dom_choiceB.textContent = indexOfQuestion.choiceB;
  dom_choiceC.textContent = indexOfQuestion.choiceC;
...
function renderSCore() {
  ...
  const scorePerCent = Math.round(100/questions.length*score);
