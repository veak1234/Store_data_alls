...
/**
 * Title: Page Title
 * Slug: elevated-lite/page-title
 * Categories: elevated-lite, page-title
 */
?>
...
<div class="wp-block-group alignwide"><!-- wp:post-title {"textAlign":"center","style":{"typography":{"letterSpacing":"1px"}},"textColor":"Background","fontSize":"gigantic"} /--></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->